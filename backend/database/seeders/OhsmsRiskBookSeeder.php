...
/**
 * كتاب المخاطر من OHSMS — **لا يُبذر بعد قرار ٢٢ (٢٠٢٦-٠٩-٠٩)؛ يبقى مرجعاً للصياغة فقط**: التصنيف بثلاث درجات (٩ رئيسية، ٦٤ فرعية، ٥٤ نوعاً) و٢٦٤ خطراً
 ...
 */
class OhsmsRiskBookSeeder extends Seeder
{
