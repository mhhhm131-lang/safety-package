...
@section('page_title', 'إضافة خطر — السجل الفعلي')
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1" style="color:var(--text-main);">
                <i class="bi bi-shield-plus me-2" style="color:#e74c3c;"></i>إضافة خطر في السجل الفعلي
            </h4>
            <small style="color:var(--text-muted);">السجل الفعلي — المخاطر النشطة التي تُدار على أرض الواقع</small>
        </div>
        <a href="{{ route('risk.active.index') }}" class="btn btn-outline-secondary">
    ...
    <form method="POST" action="{{ route('risk.active.store') }}">
        @csrf
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <input type="text" name="title" class="form-control" maxlength="300" value="{{ old('title', '') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="contact_channel" class="form-control" maxlength="200" value="{{ old('contact_channel', '') }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex gap-2">
            <button type="submit" class="btn btn-danger btn-lg px-5"><i class="bi bi-check-lg me-2"></i>حفظ في السجل الفعلي</button>
