...
class CloseoutService
{
    ...
    public const REFERENCE = [
        // الحوكمة والحسابات
        'users', 'user_profiles', 'place_coverages' /* ٢٠-٢: تغطية الحساب تتبع الحساب */, 'organization_units', 'places', 'place_units' /* ١٨-٣: وحدات الأماكن تُدخل مرة وتبقى */, 'settings', 'institute_documents',
