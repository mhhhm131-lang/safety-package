...
{
    private const MANAGEMENT_ROLES = ['top_management', 'safety_committee', 'branch_manager', 'department_manager', 'section_manager'];

    /** الأدوار المعهدية المضافة: اطلاع على الكل (مؤقت حتى يقرر المستخدم — BACKEND.md الفجوة ٩). */
    private const INSTITUTE_VIEW_ALL = ['top_management', 'safety_committee', 'admin_eng_manager', 'facilities_manager', 'security_safety_head', 'support_team'];
